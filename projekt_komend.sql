...
CREATE TABLE IF NOT EXISTS `arekkowalski`.`towar` (
  ...
  `woda` ENUM('gazowana', 'niegazowana') NULL DEFAULT NULL,
  `pieczywo` ENUM('chleb', 'bułka') NULL DEFAULT NULL,
  `chleb` ENUM('pszenny', 'razowy') NULL DEFAULT NULL,
  `bułka` ENUM('pszenna', 'razowa') NULL DEFAULT NULL,
  `słodycze` ENUM('batonik', 'czekolada') NULL DEFAULT NULL,
  `batonik` ENUM('czekoladowy', 'karmelowy') NULL DEFAULT NULL,
  `czekolada` ENUM('mleczna', 'gorzka') NULL DEFAULT NULL,
